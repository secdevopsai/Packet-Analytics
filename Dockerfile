...
RUN apt-get install -y curl grep sed wget dpkg && \
...
RUN wget https://anaconda.org/secdevopsai/project/packet-analytics/download
RUN mv download packet-analytics.tar.bz2

RUN anaconda-project unarchive packet-analytics.tar.bz2
